...
import revenueSourceRoutes from './routes/revenueSourceRoutes.js';
import financialReportRoutes from './routes/financialReportRoutes.js';
import memberAccessRoutes from './routes/memberAccessRoutes.js';
...
app.use(cors({
  origin: [
    ...
    'http://localhost:3000',
    'http://127.0.0.1:5173',
    'https://gym-management-kx5h.onrender.com',
    'https://www.gym-management-kx5h.onrender.com'
  ],
  credentials: true
}));
...
app.use('/api/v1/revenue-sources', revenueSourceRoutes);
app.use('/api/v1/financial-reports', financialReportRoutes);
app.use('/api/v1/member-access', memberAccessRoutes);
