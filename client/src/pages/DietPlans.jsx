...
import CreateDietPlanModal from '../components/diet-plans/CreateDietPlanModal';
...
const DietPlans = () => {
    ...
    const handlePlanSaved = () => {
        showSuccess(`Diet plan ${editingPlan ? 'updated' : 'created'} successfully`);
        loadPlans();
    ...
    const handleDeleteConfirm = async () => {
        ...
        try {
            await dietPlanService.deleteDietPlan(planToDelete._id);
        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400">Manage diet templates and assign them to members.</p>
                </div>
                                ...
                                <div className="mt-auto">
                                    <div className="bg-gray-50 dark:bg-slate-800 rounded-lg p-3 text-sm text-gray-600 dark:text-gray-300">
                                        <div className="font-medium text-gray-900 dark:text-white mb-1">
                                            {plan.meals?.length || 0} Meals Scheduled
                                        </div>
                                    </div>
                                </div>
                            </div>
